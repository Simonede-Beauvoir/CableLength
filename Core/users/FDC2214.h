...
#define F_REF 43400000.0   
#define L_SENSOR 0.000018  
#define C_BOARD 33e-12    
#define PI    3.14159265358979f

uint8_t FDC2214_Init();
uint32_t FDC2214_GetCapacitanceData(uint8_t channel);
double FDC2214_100pf(uint8_t channel);
double FDC2214_Measure_High_Precision(uint8_t channel, uint32_t sample_time_ms);//(新增)同轴线缆题
